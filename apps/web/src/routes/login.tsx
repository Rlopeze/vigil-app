      ...
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ width: "100%", maxWidth: 400, padding: "0 20px" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            ...
            <p style={{ color: "rgba(244,239,230,0.35)", fontSize: 14, marginTop: 12 }}>Sign in to your account</p>
          </div>
          ...
          <p style={{ textAlign: "center", marginTop: 24, fontSize: 13, color: "rgba(244,239,230,0.3)" }}>
            ...
            <a href="/signup" style={{ color: "#d4613e", textDecoration: "none", fontWeight: 500 }}>Sign up</a>
          </p>
        </div>
      </div>
    </>
